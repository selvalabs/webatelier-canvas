...
from webdesign_ai_editor.domain.projects import ProjectCreate, ProjectProfile, ProjectUpdate
...
def create_project_router(service: ProjectService) -> APIRouter:
    ...
    async def update_project(project_id: UUID, request: ProjectUpdate) -> ProjectProfile:
        try:
